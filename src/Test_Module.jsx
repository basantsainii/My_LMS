  ...
  return (
    <>
      <div>
        ...
        <NavLink to = 'Create_test' className={({ isActive, isPending }) => isActive ? "border border-blue-700 p-1 px-2 mr-2 rounded-md bg-blue-800 text-white" : isPending ? "border border-blue-700 p-1 px-2 mr-2 rounded-md text-blue-800 hover:bg-blue-800 hover:text-white " : "border border-blue-700 p-1 px-2 mr-2 rounded-md text-blue-800 hover:bg-blue-800 hover:text-white"}>Create Test</NavLink>
